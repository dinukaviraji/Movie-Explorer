...
const Footer = () => {
  return (
    ...
    sx={{ width: '100%',py: 2, px: 3,mt: 'auto',textAlign: 'center',color: 'white', backgroundColor: 'rgba(0, 0, 0, 0.3)', backdropFilter: 'blur(6px)'}}>
        <Typography sx={{fontSize: { xs: '0.8rem', md: '1rem' }, fontFamily: 'ClashGrotesk', fontWeight:500, mb: 1, a: {color: '#71797E', textDecoration: 'none', '&:hover': {color: 'white'}}}}>
        ...
        <Typography sx={{fontSize: { xs: '0.8rem', md: '1rem' }, fontFamily: 'ClashGrotesk'}}>
